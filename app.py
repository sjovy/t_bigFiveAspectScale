...
def render_welcome():
    ...
    with col2:
        ...
        The **Big Five Aspect Scale** measures personality across **5 major dimensions** and **10 specific aspects**,
        providing more nuanced insights than traditional personality tests.
